        ...
        <div class="row">
            <div class="col-lg-8 m-auto">
                <div class="about-inner-header heading9 text-center">
                    ...
                    <a href="index.html">Home <i class="fa-solid fa-angle-right"></i> Services <i class="fa-solid fa-angle-right"></i> <span>PPC</span></a>
                </div>
            </div>
        </div>
    </div>
                    ...
                    <div class="row">
                        <div class="col-lg-6 col-md-6">
                            <div class="history-box-content">
                                ...
                                <a href="case-single.html" class="readmore">Read More <i class="fa-solid fa-arrow-right"></i></a>
                            </div>
                        </div>
        ...
        <div class="row">
            ...
            <div class="col-lg-12 m-auto">
                ...
                <div class="btn-area1 text-center">
                    <a href="pricing.html" class="header-btn1">View Compare Plan <span><i class="fa-solid fa-arrow-right"></i></span></a>
                </div>
            </div>
        </div>
    </div>
