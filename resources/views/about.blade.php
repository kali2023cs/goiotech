    ...
    <div class="row align-items-center">
      ...
      <div class="col-lg-5">
        <div class="about-content-area heading2">
          ...
          <p data-aos="fade-left" data-aos-duration="1000">At GOIO, we specialize in delivering high-performance website and software solutions tailored to your business needs. Our expertise in web development, SEO optimization, and custom application development ensures seamless digital transformation for your business.</p>
        ...
        <div class="row">
            <div class="col-lg-6">
                <div class="works-header-area heading2">
                    ...
                    <p>At GOIO we understand that you have many options when it comes to digital solutions. Here's why we stand out:</p>
    ...
    <div class="row">
      <div class="col-lg-12 m-auto">
        <div class="service2-header heading2 text-center">
          ...
          <h5>Our Value</h5>
          <h2>Comprehensive Digital Solutions <br class="d-md-block d-none"> For Your Business Growth</h2>
          <p>We pride ourselves on delivering a value proposition that goes beyond expectations. Our <br class="d-md-block d-none"> approach combines technical excellence with business understanding.</p>
        </div>
      </div>
    </div>
    <div class="row">
        ...
        <div class="row">
            <div class="col-lg-8 m-auto">
                <div class="history-header-area text-center heading2">
                    ...
                    <img src="assets/img/elements/star7.png" alt="" class="star3 keyframe5">
                    <h5>Our Story</h5>
                    <h2>Embarking on a Journey <br class="d-lg-block d-none"> Fueled by Innovation</h2>
                </div>
            </div>
        </div>
        <div class="row align-items-center">
                ...
                <div class="about-all-images-area">
                    ...
                    <div class="row">
                        <div class="col-lg-6 col-md-6">
                            <div class="img1 image-anime">
                                <div class="space100"></div>
                                <img src="assets/img/all-images/history-img1.png" alt="">
                            </div>
                        </div>
                        <div class="col-lg-6 col-md-6">
                            <div class="img2 image-anime">
                                <img src="assets/img/all-images/history-img2.png" alt="">
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <div class="row">
      <div class="col-lg-12 m-auto">
        <div class="testimonial-header heading2 text-center">
          ...
          <img src="assets/img/elements/star7.png" alt="" class="star3 keyframe5">
          <h5>Testimonials</h5>
          <h2>What Our Clients Say <br class="d-md-block d-none"> About Our Services</h2>
          <p>Don't just take our word for it. Hear what our satisfied clients <br class="d-md-block d-none"> have to say about working with our development team.</p>
        </div>
      </div>
    </div>
    <div class="row">
        ...
        <div class="testimonials-slider-area owl-carousel">
          <div class="testimonial-boxarea">
            <div class="row">
              <div class="col-lg-5">
                <div class="pera">
                  <p>"GOIO transformed our online presence with a stunning website that perfectly represents our brand. Their attention to detail and technical expertise resulted in a 40% increase in our online conversions."</p>
                  <div class="space100"></div>
                  ...
                  <div class="list-area">
                    <div class="list">
                      ...
                      <a href="team.html">Michael Johnson</a>
                    </div>
          ...
          <div class="testimonial-boxarea">
            <div class="row">
              <div class="col-lg-5">
                <div class="pera">
                  <p>"The custom web application GOIO developed streamlined our operations and saved us countless hours. Their team understood our unique requirements and delivered a solution that exceeded our expectations."</p>
                  <div class="space100"></div>
                  <div class="space30"></div>
                  <div class="list-area">
                    <div class="list">
                      ...
                      <a href="team.html">Sarah Williams</a>
                    </div>
                    <img src="assets/img/icons/google.svg" alt="">
                  </div>
                </div>
          ...
          <div class="testimonial-boxarea">
            <div class="row">
              <div class="col-lg-5">
                <div class="pera">
                  <p>"After implementing GOIO's SEO strategies, our organic traffic increased by 300% in just six months. Their technical SEO audit identified critical issues we didn't even know we had."</p>
                  <div class="space100"></div>
                  <div class="space30"></div>
                  <div class="list-area">
                    <div class="list">
                      ...
                      <a href="team.html">Robert Chen</a>
                    </div>
                    <img src="assets/img/icons/google.svg" alt="">
                  </div>
                </div>
