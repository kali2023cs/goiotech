    ...
    <div class="row align-items-center">
      <div class="col-lg-6">
        <div class="header-main-content heading1">
          <h5><img src="assets/img/icons/logo-icons.svg" alt="">Leading Website & Software Development</h5>
<h1 class="text-anime-style-3">Transform Your Ideas Into Powerful Digital Solutions</h1>
      ...
      <div class="col-lg-6">
        <div class="header-images-area">
          <div class="main-images-area">
            <div class="img1">
              <img src="assets/img/all-images/lady_png (1).png" alt="" data-aos="zoom-in" data-aos-duration="1000">
            </div>
            <div class="img2">
    ...
    <div class="row">
      <div class="col-lg-12 m-auto">
        <div class="service-header-area heading2 text-center">
          ...
          <h2 class="text-anime-style-3">Leading Website & Software Development Services <br class="d-md-block d-none"> to Accelerate Your Business Growth</h2>
          <p data-aos="fade-up" data-aos-duration="1000">Our experienced team delivers custom-built digital solutions designed to enhance <br class="d-md-block d-none"> your online presence, optimize operations, and drive business success.</p>
      ...
      <div class="col-lg-12">
        <div class="service-all-boxes-area">
          ...
          <div class="service-boxarea box2" data-aos="zoom-in" data-aos-duration="1000">
            ...
            <div class="space40"></div>
            <p>Build powerful, scalable, and user-friendly web applications for businesses of all sizes. Our experts deliver secure and high-performance solutions.</p>
          </div>
    ...
    <div class="row">
      <div class="col-lg-12 m-auto">
        <div class="case-header-area heading2 text-center">
          <img src="assets/img/elements/star2.png" alt="" class="star2 keyframe5">
          <img src="assets/img/elements/star2.png" alt="" class="star3 keyframe5">
          <h2 class="text-anime-style-3">Benefits of Website & Softwares</h2>
          <p data-aos="fade-up" data-aos-duration="1000">Investing in professional website and softwares enhances efficiency, <br class="d-md-block d-none"> improves user experience, and drives business growth.</p>
        </div>
      </div>
    </div>
    <div class="row">
    ...
    <div class="row">
      <div class="col-lg-12 m-auto">
        <div class="testimonial-header heading2 text-center">
          <img src="assets/img/elements/star2.png" alt="" class="star2 keyframe5">
          <img src="assets/img/elements/star2.png" alt="" class="star3 keyframe5">
          <h2 class="text-anime-style-3">What Our Clients Say <br class="d-md-block d-none"> on Google Reviews</h2>
          <p data-aos="fade-up" data-aos-duration="1000">Don't just take our word for it. Hear what our satisfied clients <br class="d-md-block d-none"> have to say about their experience working with us.</p>
        </div>
      </div>
    </div>
    <div class="row">
    ...
    <div class="row">
      <div class="col-lg-12 m-auto">
        <div class="blog-hedaer-area heading2 text-center">
          <img src="assets/img/elements/star2.png" alt="" class="star2 keyframe5">
          <img src="assets/img/elements/star2.png" alt="" class="star3 keyframe5">
          <h2 class="text-anime-style-3">Tech Trends & Innovations: <br class="d-md-block d-none"> Our Latest Blog Posts</h2>
          <p data-aos="fade-up" data-aos-duration="1000">Explore our blog for expert insights, industry trends, and <br class="d-md-block d-none"> innovative solutions that drive business success.</p>
        </div>
      </div>
    </div>
    <div class="row">
    ...
    <div class="row">
      <div class="col-lg-12 m-auto">
        <div class="contact-header-area text-center heading2">
          ...
          <p>We're here to help! Whether you need a custom website, powerful software solutions, <br class="d-md-block d-none"> or expert digital marketing strategies, our team is ready to assist you.</p>          
        </div>
      </div>
    </div>
    <div class="row">
      <div class="col-lg-5" data-aos="zoom-out" data-aos-duration="1000">
        <div class="contact-info-area">
          <h3>Contact Info</h3>
          <p>We're here to help! If you have any questions or would like to discuss how our website development and software solutions can enhance your business, feel free to reach out.</p>
      ...
      <div class="col-lg-7" data-aos="zoom-out" data-aos-duration="1200">
        <div class="contact-boxarea">
           <h3>Get In Touch</h3>
           <p>Have questions? Let's discuss how our website and software solutions can grow your business.</p>
